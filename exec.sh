...
if [[ "$#"  -ge  "1"  &&   $1 = "-a" ]] || [[ "$#"  -ge "2"   &&   $2 = "-a" ]] || [[ "$#"  -ge "3"  &&  $3 = "-a" ]] || [[ "$#"  -ge "4"  &&  $3 = "-a" ]] || [[ "$#"  -ge "5"  &&  $5 = "-a" ]]
then
	export front=4000
	export http=4001
	export https=4333
...
elif [[ "$#"  -ge  "1"  &&  $1 = "-f" ]] || [[ "$#"  -ge  "2"  &&  $2 = "-f" ]] || [[ "$#"  -ge  "3"  &&  $3 = "-f" ]] || [[ "$#"  -ge "4"  &&  $3 = "-f" ]] || [[ "$#"  -ge "5"  &&  $5 = "-f" ]]
then
	export front=5000
	export http=5001
	export https=5333
...
if [[ "$#"  -ge "1"  &&   $1 = "-d" ]] || [[ "$#"  -ge "2"   &&   $2 = "-d" ]] || [[ "$#"  -ge "3"  &&  $3 = "-d" ]] || [[ "$#"  -ge "4"  &&  $3 = "-d" ]] || [[ "$#"  -ge "5"  &&  $5 = "-d" ]]
then
	option="-d"
fi
