            ...
            <>
                ...
                <Stack direction="column" justifyContent="center" alignItems="center" spacing={5} sx={{marginTop: 1}}>
                    ...
                    <Stack direction="row" spacing={2} justifyContent="center" alignItems="center">
                        <ButtonBase centerRipple className="button" style={{width: width_button, height: '50px', borderRadius: 0, backgroundColor: "red"}} onClick={() => {this.setState({visibility: "public"})}}>
                            <Typography variant="button" color='white'>
                                <div className='bit5x5'> Public </div>
                            </Typography>
                        </ButtonBase>
                        <ButtonBase centerRipple className="button" style={{width: width_button, height: '50px', borderRadius: 0, backgroundColor: "red"}} onClick={() => {this.setState({visibility: "private"})}}>
                            <Typography variant="button" color='white'>
                                <div className='bit5x5'> Private </div>
                            </Typography>
                        </ButtonBase>
                        <ButtonBase centerRipple className="button" style={{width: width_button, height: '50px', borderRadius: 0, backgroundColor: "red"}} onClick={() => {this.setState({visibility: "protected"})}}>
                            <Typography variant="button" color='white'>
                    ...
                    <Stack justifyContent="center" alignItems="center">
                        <InputBase sx={{width: "480px"}} inputProps={{min: 0, style: { textAlign: 'center' }}} className="lockinput" placeholder="Password" onChange={ async (e) => {}}/>
                    </Stack>
                    <Stack direction="row" spacing={2} justifyContent="center" alignItems="center">
                        <ButtonBase centerRipple className="button" style={{width: "450px", height: '50px', borderRadius: 0, backgroundColor: "red"}} onClick={() => {this.Sendchannel()}}>
                            <Typography variant="button" color='white'>
