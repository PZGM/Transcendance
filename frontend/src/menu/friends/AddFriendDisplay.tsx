...
type AddFriendDisplayProps = {
	user: UserDto;
	addFriend: any;
}

interface AddFriendDisplayState {
	done: boolean;
}

export class AddFriendDisplay extends Component<AddFriendDisplayProps, AddFriendDisplayState>{

	eventSource: any;

	constructor(props: AddFriendDisplayProps) {
		super(props);
