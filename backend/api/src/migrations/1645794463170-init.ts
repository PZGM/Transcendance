...
export class init1645794463170 implements MigrationInterface {
    name = 'init1645794463170'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "intra_id " character varying NOT NULL, "login" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "img_url" character varying NOT NULL, "status" integer NOT NULL, "friends" integer array NOT NULL DEFAULT '{}', CONSTRAINT "UQ_03fdc0fd5d99b58560c4ca6e0ba" UNIQUE ("intra_id "), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
